...
class DataGenerator(Dataset):
    def __init__(self, data_path, config, mode='unseen'):
        ...
        # self.index_to_label = {0: 'BOOK', 1: 'PLAYLIST', 2:'MUSIC', 3:'WEATHER', 4:'MOVIE', 5:'RESTAURANT', 6:'SEARCH'}
            ...
            elif config['g_file_name'] == "./G_data/SNIPg-dataset.jsonl":
                self.index_to_label = {0: 'rate book', 1:'add to playlist'}

            elif config["g_file_name"] ==  "./G_data/CLINCg-dataset.jsonl":
                self.index_to_label = {0: 'cancel reservation', 1: 'freeze account', 2: 'current location', 3: 'how old are you', 4: 'what is your name',
                                       5: 'bill due', 6:"reset settings", 7: "travel alert",
                                       8: 'exchange rate', 9: 'shopping list' }
