...
if __name__ == '__main__':
    ...
    # Required parameters
    parser.add_argument("--output_dir", type=str, default = "./out", #required=True,
                        help="The output directory to which the generated dataset is saved")
    parser.add_argument("--task_file", type=str, default = "./task_specs/huffpost1.json", #required=True,
    ...
    parser.add_argument("--max_output_length", type=int, default=100, #200, #40
    ...
    parser.add_argument("--num_entries_per_label", type=int, default=1000,
